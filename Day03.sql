...
-- veri ismi hasan olan datayi sileleim
...
on delete cascade --yazinca parent silince child dada silinir
);
...
--Notlar tablosundan id 123 olani siliniz
DELETE FROM notlar WHERE talebe_id='123';

--Talebeler tablosundan id si 126 olan datayi sileleim
DELETE FROM talebeler WHERE id='126'; --on delete cascade kullandigimiz icin parettakini silince child danda silindi
...
--musteriler tablosundan urun isimi orange apple ve apricot olan datalari listeleyiniz
...
SELECT max(maas) AS maksimum_maas FROM calisanlar2; --maximum maasi goruruz
/*
...
SELECT count(maas) AS maas_sayısı FROM calisanlar2; --sadece maas satirinda dolu olanlari sayar
SELECT count(*) AS maas_sayısı FROM calisanlar2; --butun satirlari sayar
/*
